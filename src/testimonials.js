...
export const testimonials = {
  testimonialOne: {
    ...
    img: danielImg,
    text: `I received a job offer mid-course, and the subjects I learned were
      current, if not more so, in the company I joined. I honestly feel I got
      every penny’s worth.`,
    testimonial: `“ I was an EMT for many years before I joined the bootcamp. I’ve been
  ...
  testimonialTwo: {
    ...
    testimonial: `“ I started as a total newbie with virtually no coding skills.
  ...
  testimonialThree: {
    ...
    testimonial: `“ Thank you for the wonderful experience!
      I now have a job I really enjoy, and make a good living while doing something I love. ”`,
  },
  testimonialFour: {
    name: 'Patrick Abrams',
    img: patrickImg,
    text: `Awesome teaching support from TAs who did the bootcamp themselves.
      Getting guidance from them and learning from their experiences was easy.`,
    testimonial: `“ The staff seem genuinely concerned about my progress which I find really refreshing.
      The program gave me the confidence necessary to be able to go out in the world and
      present myself as a capable junior developer. The standard is above the rest.
  ...
  testimonialFive: {
    ...
    testimonial: `“ Before joining the bootcamp, I’ve never written a line of code.
